...
from DisplayableAntenna import DisplayableAntenna
...
class ModelLinkage(Component):
    ...
    def __init__(self, parent, position, display_obj=None):
        ...
        # link4 = Component(Point((0, 0, linkageLength)), DisplayableLeg(self.contextParent, .2, 0.2, [0.2, 0.2, linkageLength]))
        # link4.setDefaultColor(Ct.DARKORANGE4)
